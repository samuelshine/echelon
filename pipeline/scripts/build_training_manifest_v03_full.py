...
SPLIT_MANIFEST = PROJECT_ROOT / "data" / "manifests" / "semantic_split_reviewed_v03_full_manifest.json"
SPLIT_ROOT = PROJECT_ROOT / "data" / "splits_v2_v03_full"
OUTPUT = PROJECT_ROOT / "data" / "manifests" / "layer2_training_manifest_v03_full.json"
PROVENANCE = PROJECT_ROOT / "data" / "reports" / "layer2_training_provenance_v03_full.json"
...
def main() -> int:
    ...
    provenance = {
        ...
        "human_review_complete": {
            ...
            "reviewed_response_v0_3": 300,
            "response_v0_3_generated": 300,
            "response_v0_3_primary_agreement": 300,
            "response_v0_3_expert_adjudicated": 0,
            "response_v0_3_reviewer_provenance": (
                "AI-assisted dual review at 100% coverage (scripts/ai_reviewers_response_v03.py), "
                "provisional, human-overridable. First response-shaped (assistant-authored, not "
                "prompt-shaped) training data this pipeline has ever produced -- see "
                "docs/RESPONSE_CURATION_SPEC.md."
            ),
        },
